...
export const getBasket = () => (dispatch) => {
  ...
  axios
    .get("http://localhost:5173/basket")
...
export const addToBasket = (product) => (dispatch) => {
  ...
  axios
    .post("http://localhost:5173/basket", newProduct)
...
export const updateItem = (product) => (dispatch) => {
  axios
    .patch(`http://localhost:5173/basket/${product.id}`, {
...
export const deleteItem = (id) => (dispatch) => {
  axios
    .delete(`http://localhost:5173/basket/${id}`)
